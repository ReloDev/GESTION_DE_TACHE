                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 mt-3 " novalidate action="  " method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <input type="email" name="question" class="form-control" id="yourEmail" required  value=" {{$lp->nom}} " <main>
    <div class="container">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 mt-3 " novalidate action="  " method="POST">
                    ...
                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Nom du langage de programmation</label>
                      <input type="email" name="question" class="form-control" id="yourEmail" required  value=" {{$lp->nom}} " disabled>
                    </div><br>
