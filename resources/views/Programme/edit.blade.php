          ...
          <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                ...
                <form class="row g-3 mt-3 " novalidate action=" {{route('Programme.update',['id'=>$programme->id])}} " method="POST">
                  @csrf
                  <div class="col-12">
                    <label for="yourEmail" class="form-label">Nom du programme</label><br>
                    <input type="email" name="nom" class="form-control" id="yourEmail" required value=" {{$programme->nom}} ">
                  </div>
                    <br>
                    <div class="col-12">
                    ...
                    <div class="col-12" >
                      ...
                      <textarea name="note" id="" cols="30" rows="10"> {{$programme->note}} </textarea>                 
                    </div>
